...
![png](../images/7-2-18.png "图7-2-18 修改控制台密码界面")

###### 图7-2-22 修改控制台密码界面

31.添加/删除SSH Key：点击云主机界面操作列表中的添加SSH Key按钮，进入添加SSH Key界面。如图7-2-23所示，在文本框中输入要添加的SSH Key，点击确认，重启后生效。SSH key具体介绍请参考7.5章节。
