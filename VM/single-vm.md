...
25.修改高可用级别:修改高可用级别在NeverStop或None模式。
...
点击云主机界面任务管理器按钮，进入创建定时任务界面，定时任务类型分为简单定时任务和Cron定时任务。具体操作规则，点击界面上方的问号，可以查看具体使用规则，在本手册中不再累述。

![png](../images/7-2-17.png "图7-2-17 创建定时任务界面")

###### 图7-2-17 创建定时任务界面

30. 修改控制台密码：

![png](../images/7-2-18.png "图7-2-18 云主机日志界面")###### 图7-2-18 云主机日志界面

31.添加/删除SSH Key：点击云主机界面操作列表中的添加SSH Key按钮，进入添加SSH Key界面。如图7-2-19所示，在文本框中输入要添加的SSH Key，点击确认，重启后生效。SSH key具体介绍请参考7.5章节。

![png](../images/7-2-19.png "图7-2-19 添加SSH Key界面")###### 图7-2-19 添加SSH Key界面

32.检查日志: 查看云主机的相关日志记录。如图7-2-20所示。

![png](../images/7-2-20.png "图7-2-20 云主机日志界面")
###### 图7-2-18 云主机日志界面
