...
![png](../images/14-4-7-2.png "图14-4-7-2 IPsec隧道界面")
...
点击Mevoco1菜单栏的网络中的IPsec隧道按钮，进入IPsec隧道界面，如图14-4-7-2所示。

![png](../images/14-4-7-2.png "图14-4-7-2 IPsec隧道界面")
###### 图14-4-7-2 IPsec隧道界面 

点击新建按钮，弹出新建IPsec界面，如图14-4-7-3所示。需要填写名字、简介、公共网络及IP、本地子网、远端地址、远端子网、认证密钥。

![png](../images/14-4-7-3.png "图14-4-7-3 新建IPsec隧道1")

###### 图14-4-7-3 新建IPsec隧道1
...
创建mevoco1的IPsec后，打开Mevoco2的新建IPsec页面。如图14-4-7-4所示。

![png](../images/14-4-7-4.png "图14-4-7-4 新建IPsec隧道2")

###### 图14-4-7-4 新建IPsec隧道2

**注意：**两个环境中，公共网络IP和远端地址互相指定。两边的认证密钥务必保持一致。

这时两边的网络应该已经联通，我们相互ping 子网IP测试一下。如下图所示。

![png](../images/14-4-7-5.png "图14-4-7-5 连接测试1")
###### 图14-4-7-5 连接测试1


![png](../images/14-4-7-6.png "图14-4-7-6 连接测试2")
