...
admin账户可以对任一账户的消费情况进行查询和统计。点击菜单栏中用户管理下的计费按钮，可以看到各个账户的消费情况，如图19-6-1所示。

![png](../images/19-6-1.png "图19-6-1 计费界面")
###### 图19-6-1 计费界面

计费的默认起始时间为当前时间的前一个月，结束时间默认为现在。总计的价格显示此账户在选择的时间段内消费的费用总计，包含云主机的CPU、内存、云盘资源信息等。

用户可以点击账户行进入单个账户的计费页面，其中花费类型有根云盘、云主机和数据云盘，如图19-6-2所示，若账户里没有云主机或是数据云盘则不显示此项。

![png](../images/19-6-2.png "图19-6-2 单个账户计费界面")
###### 图19-6-2 单个账户计费界面

继续点击可以看到更多详情。比如，点击云主机可以看到账户下各个云主机的具体消费情况，如图19-6-3。继续点击单个云主机就可以看到该云主机下的处理器和内存分别的花费金额，如图19-6-4。

![png](../images/19-6-3.png "图19-6-3 账户下云主机计费界面")
###### 图19-6-3 账户下云主机计费界面

![png](../images/19-6-4.png "图19-6-4 单个云主机计费界面")
###### 图19-6-4 单个云主机计费界面
